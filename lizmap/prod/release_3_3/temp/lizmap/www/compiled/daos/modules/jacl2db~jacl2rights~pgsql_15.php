...
if (jApp::config()->compilation['checkCacheFiletime']&&(
 ...
 filemtime('C:\webserver\lizmap\prod\release_3_3\lib/jelix-modules/jacl2db/daos/jacl2rights.dao.xml') > 1616160725)){ return false;
}
else {
 require_once ( JELIX_LIB_PATH .'dao/jDaoRecordBase.class.php');
 require_once ( JELIX_LIB_PATH .'dao/jDaoFactoryBase.class.php');

class cDaoRecord_jacl2db_Jx_jacl2rights_Jx_pgsql extends jDaoRecordBase {
 public $id_aclsbj;
 public $id_aclgrp;
 public $id_aclres;
 public $canceled=0;
   public function getSelector() { return "jacl2db~jacl2rights"; }
   public function getProperties() { return cDao_jacl2db_Jx_jacl2rights_Jx_pgsql::$_properties; }
   public function getPrimaryKeyNames() { return cDao_jacl2db_Jx_jacl2rights_Jx_pgsql::$_pkFields; }
}

class cDao_jacl2db_Jx_jacl2rights_Jx_pgsql extends jDaoFactoryBase {
  ...
  array (
   ...
   protected $_DaoRecordClassName='cDaoRecord_jacl2db_Jx_jacl2rights_Jx_pgsql';
