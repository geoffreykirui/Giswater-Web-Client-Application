...
filemtime('C:\webserver\lizmap\preprod\master\lizmap/modules/admin/templates/config.tpl') > 1631882449){ return false;
} else {
 ...
 require_once('C:\webserver\lizmap\preprod\master\lib\jelix/plugins/tpl/html/function.ctrl_value.php');
