...
if (jApp::config()->compilation['checkCacheFiletime']&&(
 ...
 filemtime('C:\webserver\lizmap\prod\release_3_3\lib/jelix-modules/jacl2db/daos/jacl2subject.dao.xml') > 1616160725)){ return false;
}
else {
 require_once ( JELIX_LIB_PATH .'dao/jDaoRecordBase.class.php');
 require_once ( JELIX_LIB_PATH .'dao/jDaoFactoryBase.class.php');

class cDaoRecord_jacl2db_Jx_jacl2subject_Jx_pgsql extends jDaoRecordBase {
 public $id_aclsbj;
 public $label_key;
 public $id_aclsbjgrp;
 public $label_group_key;
   public function getSelector() { return "jacl2db~jacl2subject"; }
   public function getProperties() { return cDao_jacl2db_Jx_jacl2subject_Jx_pgsql::$_properties; }
   public function getPrimaryKeyNames() { return cDao_jacl2db_Jx_jacl2subject_Jx_pgsql::$_pkFields; }
}

class cDao_jacl2db_Jx_jacl2subject_Jx_pgsql extends jDaoFactoryBase {
  ...
  array (
   ...
   protected $_selectClause='SELECT "sbj"."id_aclsbj", "sbj"."label_key", "sbj"."id_aclsbjgrp", "grpsbj"."label_key" as "label_group_key"';
   protected $_fromClause;
   protected $_whereClause='';
   protected $_DaoRecordClassName='cDaoRecord_jacl2db_Jx_jacl2subject_Jx_pgsql';
