...
if (jApp::config()->compilation['checkCacheFiletime']&&(
 ...
 filemtime('C:\webserver\lizmap\prod\release_3_3\lizmap/modules/lizmap/daos/user.dao.xml') > 1616160726)){ return false;
}
else {
 require_once ( JELIX_LIB_PATH .'dao/jDaoRecordBase.class.php');
 require_once ( JELIX_LIB_PATH .'dao/jDaoFactoryBase.class.php');

class cDaoRecord_lizmap_Jx_user_Jx_pgsql extends jDaoRecordBase {
 public $login;
 public $email;
 public $password;
 public $firstname;
 ...
 public $create_date;
   ...
   public function getProperties() { return cDao_lizmap_Jx_user_Jx_pgsql::$_properties; }
   public function getPrimaryKeyNames() { return cDao_lizmap_Jx_user_Jx_pgsql::$_pkFields; }
}

class cDao_lizmap_Jx_user_Jx_pgsql extends jDaoFactoryBase {
  ...
  array (
   ...
   protected $_selectClause='SELECT "usr"."usr_login" as "login", "usr"."usr_email" as "email", "usr"."usr_password" as "password", "usr"."firstname", "usr"."lastname", "usr"."organization", "usr"."phonenumber", "usr"."street", "usr"."postcode", "usr"."city", "usr"."country", "usr"."comment", "usr"."status", "usr"."keyactivate", "usr"."request_date", "usr"."create_date"';
   protected $_fromClause;
   protected $_whereClause='';
   protected $_DaoRecordClassName='cDaoRecord_lizmap_Jx_user_Jx_pgsql';
...
';
   $result = $this->_conn->exec ($query);
  $query ='SELECT "usr_password" as "password", "create_date" FROM "'.$this->_conn->prefixTable('jlx_user').'" WHERE  "usr_login"'.' = '.$this->_conn->quote($record->login).'';
